...
public final class ActivityProjectDetailsBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView projectRecView;

  private ActivityProjectDetailsBinding(@NonNull LinearLayout rootView,
      @NonNull RecyclerView projectRecView) {
    this.rootView = rootView;
    this.projectRecView = projectRecView;
  }
  ...
  public static ActivityProjectDetailsBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.projectRecView;
      RecyclerView projectRecView = ViewBindings.findChildViewById(rootView, id);
      if (projectRecView == null) {
        break missingId;
      }

      return new ActivityProjectDetailsBinding((LinearLayout) rootView, projectRecView);
    }
